...
const SchedulePage = () => {
  ...
  const fetchSchedule = async () => {
    const res = await axios.get("http://https://the-dominators-5kpzyfw0f-snischay2s-projects.vercel.app/api/schedule");
  ...
  const addSchedule = async (e) => {
    ...
    await axios.post("http://https://the-dominators-5kpzyfw0f-snischay2s-projects.vercel.app/api/schedule", newSchedule);
    fetchSchedule();
    setNewSchedule({ title: "", date: "", time: "", type: "class", description: "" });
  };

  const deleteSchedule = async (id) => {
    await axios.delete(`http://https://the-dominators-5kpzyfw0f-snischay2s-projects.vercel.app/api/schedule/${id}`);
    fetchSchedule();
  };
