...
const AttendancePage = () => {
  ...
  const fetchAttendance = async () => {
    try {
      const res = await axios.get("http://https://the-dominators-5kpzyfw0f-snischay2s-projects.vercel.app/api/v1/attendance");
  ...
  const updateAttendance = async () => {
    try {
      await axios.put("http://https://the-dominators-5kpzyfw0f-snischay2s-projects.vercel.app/api/v1/attendance/update", {
